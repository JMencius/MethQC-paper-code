...
1. Process and QC for ONT data


2. Process and QC for PacBio data



3. MethQC on compartive samples



4. MethQC on 161 groups of ONT data from Human Pangenome Reference Consortium (HPRC)
...
We also provide a `.sh` file for each conda enironment. The installation of each conda environment may take serveral minutes, depending on your system and network.
